...
import com.asksven.betterlatitude.MyWidgetProvider;
	...
	public void onStart(Intent intent, int startId)
	{
		...
		for (int widgetId : allWidgetIds)
		{
			...
			if (bQuickSettingOn)
			{
				...
				remoteViews.setImageViewResource(R.id.icon, R.drawable.icon_widget_quick);
			}
			else
			{
				//remoteViews.setTextViewText(R.id.status, "On");
				remoteViews.setImageViewResource(R.id.icon, R.drawable.icon_widget_normal);
			}
